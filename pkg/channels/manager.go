...
func NewManager(cfg *config.Config, messageBus *bus.MessageBus, configPath string, switcher ModelSwitcher) (*Manager, error) {
	m := &Manager{
...
func (m *Manager) initChannels() error {
	...
	if m.config.Channels.Telegram.Enabled && m.config.Channels.Telegram.Token != "" {
		...
		telegram, err := NewTelegramChannel(m.config, m.bus, m.configPath, m.modelSwitcher)
		if err != nil {
